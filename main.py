...
SCREEMWIDTH = 289
SCREENHEIGHT = 511
SCREEN = pygame.display.set_mode((SCREEMWIDTH,SCREENHEIGHT))
GROUNDY = SCREENHEIGHT * 0.8
GAME_SPRITES = {}
GAME_SOUNDS = {}
PLAYER = '/gallery/sprites/bird.png'
BACKGROUND = '/galley/sprites/background.jpg'
PIPE = '/galley/sprites/pipe.png'
...
if __name__ == '__main__':
    ...
    GAME_SPRITES['backgroung'] = pygame.image.load(BACKGROUND).convert_alpha()
